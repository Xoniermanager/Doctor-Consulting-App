  ...
  const columns = [
    ...
    },
    {
      ...
      <div className="d-flex">
        <Link to={`/view-prescription/${row._id}`} className="btn btn-success shadow btn-xs sharp mr-1"><i className="fa fa-eye"></i></Link>
        <Link to={`/print-prescription/${row._id}`} className="btn btn-info shadow btn-xs sharp mr-1"><i className="fa fa-print"></i></Link>
        <Link to={`/edit-prescription/${row._id}`} className="btn btn-primary shadow btn-xs sharp mr-1"><i className="fa fa-pencil"></i></Link>
        <button type='button' id={row._id} onClick={handleDeleteClick} className="btn btn-danger shadow btn-xs sharp"><i className="fa fa-trash"></i></button>
      </div>,
      name: "ACTIONS",
      selector: "actions",
    },
